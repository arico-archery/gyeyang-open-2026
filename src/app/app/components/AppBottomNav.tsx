...
export default function AppBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 safe-area-bottom">
      ...
      {/* QR Scan FAB for judge/admin */}
      {showScan && (
        <Link
          href="/app/scan"
          className="absolute -top-6 left-1/2 -translate-x-1/2 w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center shadow-lg border-4 border-white"
        >
