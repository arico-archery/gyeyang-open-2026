...
export default function Hero() {
  ...
  return (
    <>
      {/* HERO — simplified: poster left, key info right, no clutter */}
      <section className="relative bg-white overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-[auto_1fr] gap-12 lg:gap-16 items-center">
            {/* Poster — left, sized down for breathing room */}
            <div className="flex justify-center lg:justify-start">
              <Image
                ...
                width={1200}
                height={1697}
                className="rounded-xl shadow-lg w-56 sm:w-64 md:w-72 lg:w-80 h-auto"
                priority
              />
            </div>

            {/* Info — right, clean vertical rhythm */}
            <div className="flex flex-col gap-8">
              ...
              {/* Social — brand-colored circular buttons */}
              <div className="flex items-center gap-3 pt-2 border-t border-slate-100">
                <span className="text-xs text-slate-400 uppercase tracking-wider mr-1">SNS</span>
                <a href="https://www.facebook.com/happygyeyang/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full flex items-center justify-center text-white bg-[#1877F2] shadow-sm hover:opacity-90 hover:scale-105 transition-all" aria-label="Facebook">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.instagram.com/gyeyangopen/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full flex items-center justify-center text-white bg-gradient-to-tr from-[#FEDA75] via-[#D62976] to-[#4F5BD5] shadow-sm hover:opacity-90 hover:scale-105 transition-all" aria-label="Instagram">
                ...
                <a href="https://www.youtube.com/@GyeyangOpen" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full flex items-center justify-center text-white bg-[#FF0000] shadow-sm hover:opacity-90 hover:scale-105 transition-all" aria-label="YouTube">
